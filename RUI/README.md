...
* Компоновщики (`*_Composer`) — алгоритмы распределения дочерних узлов.
...
2. **PostProcessBindings (Wire):** связывание полей и внедрение зависимостей по всему дереву, когда все ноды экрана уже существуют в памяти.
